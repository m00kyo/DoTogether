...
return [
    ...
    'between'              => [
        ...
        'numeric' => 'Pole :attribute musi mieścić się w zakresie od :min do :max.',
    ...
    'missing_if'           => 'Pole :attribute musi być pominięte, gdy :other wynosi :value.',
    'missing_unless'       => 'Pole :attribute musi być pominięte, chyba że :other wynosi :value.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Nazwy atrybutów (wyświetlane w komunikatach błędów)
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'nickname'         => 'nick',
        ...
        'required_age'     => 'ograniczenie wiekowe',
